...
var bar=new RadialProgress(document.getElementById("bar"),{progress:0.7,colorFg:"#0093d3",thick:50,fixedTextSize:0.35});
var v = document.getElementById("valueBar").value;
bar.setValue(v);
